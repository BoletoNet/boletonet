...
{
    [TestClass]
    public class BancoBrasil17043Teste
    {
        #region Carteira 17-043

        private BoletoBancario GerarBoletoCarteira17043()
        {
            DateTime vencimento = new DateTime(2012, 6, 14);

            var cedente = new Cedente("00.000.000/0000-00", "Empresa Teste", "0131", "7", "00059127", "0");

            BoletoNet.Boleto boleto = new BoletoNet.Boleto(vencimento, 1700, "17-043", "18204", cedente);
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17043_NossoNumero_ComCodigoConvenio_4Posicoes()
        {
            var boletoBancario = GerarBoletoCarteira17043();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17043_NossoNumero_ComCodigoConvenio_6Posicoes()
        {
            var boletoBancario = GerarBoletoCarteira17043();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17043_NossoNumero_ComCodigoConvenio_7Posicoes()
        {
            var boletoBancario = GerarBoletoCarteira17043();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17043_LinhaDigitavel()
        {
            var boletoBancario = GerarBoletoCarteira17043();
        ...
        [TestMethod]
        public void BancoDoBrasil_Carteira_17043_CodigoBarra()
        {
            var boletoBancario = GerarBoletoCarteira17043();
