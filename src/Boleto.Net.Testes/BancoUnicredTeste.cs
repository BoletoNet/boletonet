...
namespace BoletoNet.Testes
{
    ...
    public class BancoUnicredTeste
    {
        ...
        public void Unicred_GerarRemessa()
        {
            ...
            var arquivoTeste = "13600000         235342670000170                    00001900000000000010EMPRESA MODELO S/A            UNICRED DO BRASIL                       1" + dataRemessa + horaRemessa + "00000108500000000                                                                  \r\n" +
                               "13600011R01  044 2035342670000170                    00001900000000795020EMPRESA MODELO S/A                                                                                            00000001" + dataRemessa + "        00                               \r\n" +
                               "1360001300001P 010000190000000795020000000000000        09    DOC 123        " + dataVencimentoStr + "000000000105000      N N" + dataProcessamentoStr + "5        000000000000000000000000000000000000000               000000000000000DOC 123                  300    090000000000 \r\n" +
                               "1360001300002Q 012035342670000170JOSE DA SILVA                           AV. DAS ROSAS, 10                       JARDIM FLORIDO 86300000CORNELIO PROCOPPR0000000000000000                                                                       \r\n" +
