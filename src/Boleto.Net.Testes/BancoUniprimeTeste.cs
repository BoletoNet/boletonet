...
namespace BoletoNet.Testes
{
    ...
    public class BancoUniprimeTeste
    {
        ...
        public void Uniprime_GerarRemessa()
        {
            ...
            var dataProcessamentoStr = string.Format("{0}{1}{2}", DateTime.Today.Day.ToString("00"), DateTime.Today.Month.ToString("00"), DateTime.Today.ToString("yy"));
            var arquivoTeste = "01REMESSA01COBRANCA       00000000000000444601EMPRESA MODELO S A            084UNIPRIME       "+dataRemessa+"        MX0000001                                                                                                                                                                                                                                                                                     000001\r\n"+
                               "1                   00090000100795020DOC 123                  08400000100010001282          1               01000DOC 123"+dataVencimentoStr+"0000000105000        01N"+dataProcessamentoStr+"000000000000000000000000000000000000             00000000000000235342670000170JOSE DA SILVA                           AV. DAS ROSAS, 10                                   86300000      JARDIM FLORIDO000000000000000000000CORNELIO PROCOPIOPR000002\r\n"+
                               "9                                                                                                                                                                                                                                                                                                                                                                                                         000003\r\n";
