    ...
    internal class Banco_Sicoob : AbstractBanco, IBanco
    {
        ...
        public override string GerarDetalheSegmentoRRemessa(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                detalhe += "01"; //Posição 016 a 017       '01'  =  Entrada de Títulos
                detalhe += "1"; //Posição 118  - Código do desconto
                detalhe += Utils.FormatCode(boleto.DataOutrosDescontos.ToString("ddMMyyyy"), 8); //Posição 19 a 23  - Data do Desconto 2
                string valorDesconto2 = boleto.OutrosDescontos.ToString("f").Replace(",", "").Replace(".", "");
                valorDesconto2 = Utils.FormatCode(valorDesconto2, 15);  //Posição 151 a 165  - Valor/Percentual a ser Concedido
