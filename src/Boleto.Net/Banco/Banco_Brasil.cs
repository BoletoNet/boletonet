    ...
    internal class Banco_Brasil : AbstractBanco, IBanco
    {
        ...
        public override DetalheSegmentoURetornoCNAB240 LerDetalheSegmentoURetornoCNAB240(string registro)
        {
            try
            {
                ...
                segmentoU.DataCredito = registro.Substring(145, 8) == "00000000" ? 
                    ...
                    DateTime.ParseExact(registro.Substring(145, 8), "ddMMyyyy", CultureInfo.InvariantCulture);
        ...
        public string GerarHeaderRemessaCNAB400(Cedente cedente, int numeroArquivoRemessa)
        {
            try
            {
                ...
                reg.CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediNumericoSemSeparador_, 0130, 007, 0, cedente.Codigo, '0'));                                   //130-136
