...
namespace BoletoNet
{
    public interface IBanco
    {
        ...
        string FormataDescricaoCarteira(Boleto boleto);
        /// <summary>
        ...
        /// <summary>
        /// Método para permitir override de funcionalidades na propriedade GeraHtmlReciboCedente
        /// </summary>
        /// <param name="registro"></param>
        /// <returns></returns>
        void OnGeraHtmlReciboCedente(StringBuilder bdr, Boleto boleto);
        ...
        /// <param name="registro"></param>
        /// <returns></returns>
        StringBuilder RenderizaBoleto(StringBuilder bdr, BoletoBancario.BoletoRenderParams boletoBancario);
