    ...
    internal class Banco_Caixa : AbstractBanco, IBanco
    {
        ...
        public string GerarDetalheSegmentoPRemessaCNAB240(Boleto boleto, int numeroRegistro, string numeroConvenio, Cedente cedente)
        {
            try
            {
                ...
                header += " ";                                                                          // Uso Exclusivo FEBRABAN/CNAB
                header += boleto.CodMovimento;                                                                         // Código de Movimento Remessa 
                header += Utils.FormatCode(cedente.ContaBancaria.Agencia, "0", 5);                      // Agência Mantenedora da Conta 
        ...
        public string GerarDetalheSegmentoPRemessaCNAB240SIGCB(Cedente cedente, Boleto boleto, int numeroRegistro)
        {
            try
            {
                ...
                reg.CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediNumericoSemSeparador_, 0016, 002, 0, boleto.CodMovimento", '0'));                                          // posição 16 até 17   (2) - Código de Movimento Remessa
                ...
                //por ivanteles alterado para 0 fixo por recomendação da caixa
        ...
        public string GerarTrailerLoteRemessaCNAC240SIGCB(int numeroRegistro)
        {
            try
            {
                ...
                //por ivanteles alterado de 015 para 021, a caixa exgie que tenha 17 zeros para cobrança com nosso número com 17 posições exigido pela cobrança SIGCB
                reg.CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediNumericoSemSeparador_, 0076, 021, 2, "0", '0'));                                           // posição 76 até 92   (15)- Quantidade de Títulos em Carteiras 
