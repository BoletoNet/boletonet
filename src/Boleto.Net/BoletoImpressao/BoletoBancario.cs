	...
	public class BoletoBancario : System.Web.UI.Control
	{
		...
		public string GeraHtmlReciboCedente()
		{
			try
			{
                ...
                // Caso não encontre a instrução preenchida, apenas apaga.
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras, string urlImagemSegundaVia)
		{
			...
			else
			{
                ...
                {
					agenciaCodigoCedente = string.Format("{0}/{1}", Cedente.ContaBancaria.Agencia, Utils.FormatCode(Cedente.ContaBancaria.Conta, 6));
                } 
			...
			#region Implementação para o Banco do Brasil
                ...
                .Replace("@URLIMAGEMSEGUNDAVIA", SegundaVia ? urlImagemSegundaVia : "")
                .ToString();
		}
        ...
        protected StringBuilder HtmlOffLine(string textoNoComecoDoEmail, string srcLogo, string srcBarra, string srcCodigoBarra, string srcSegundaVia, bool usaCSSPDF = false)
        ...
        public string MontaHtmlEmbedded(bool convertLinhaDigitavelToImage = false, bool usaCSSPDF = false) {
            ...
            var s = HtmlOffLine(null, fnLogo, fnBarra, fnCodigoBarras, fnSegundaVia, usaCSSPDF).ToString();
